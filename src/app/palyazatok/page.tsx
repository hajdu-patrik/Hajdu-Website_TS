...
export default function PalyazatokPage() {
  return (
    <main className="min-h-screen pt-20 pb-40 px-6 transition-colors duration-500">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-800/40 backdrop-blur-md rounded-[3rem] shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700/50 flex flex-col">
          ...
          <div className="relative w-full h-80 md:h-[450px]">
            ...
            <div className="absolute bottom-8 left-8">
               <span className="bg-blue-600 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest">Sikeres projekt</span>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12 space-y-10">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="space-y-2">
                <span className="text-blue-600 dark:text-blue-400 font-bold text-sm uppercase tracking-widest">Projekt címe</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-slate-100/50 dark:bg-slate-900/50 rounded-3xl flex items-center gap-5 border border-slate-200 dark:border-slate-700">
                <div className="p-4 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-600/30">
                   <Award size={32} />
                </div>
                <div>
                  <span className="block text-xs text-slate-500 uppercase font-bold">Támogatás összege</span>
              ...
              <div className="p-6 bg-slate-100/50 dark:bg-slate-900/50 rounded-3xl flex items-center gap-5 border border-slate-200 dark:border-slate-700">
                ...
                <div>
                  <span className="block text-xs text-slate-500 uppercase font-bold">Támogatás mértéke</span>
            ...
            <div className="prose dark:prose-invert max-w-none">
              <h3 className="text-xl font-bold mb-4 text-slate-800 dark:text-white">A projekt tartalma</h3>
            ...
            <div className="pt-8 border-t border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row justify-between gap-4 text-sm font-mono text-slate-500">
              <div>Azonosító: <span className="font-bold text-blue-600">VEKOP-1.2.6-20-2020-01551</span></div>
